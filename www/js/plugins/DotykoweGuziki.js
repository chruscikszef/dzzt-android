 ...
 *
 * @help
 * Plugin tworzy element HTML (Touch UI) i dodaje przełącznik w menu Opcje.
 * Teraz na 100% domyślnie włączony przy pierwszym uruchomieniu.
 */
...
(function() {
    ...
    const optionName = String(params['Option Name'] || "Przycisk Dotykowy");

    // --- REJESTRACJA W CONFIGMANAGER ---
    
    // Kluczowe: Ustawiamy domyślną wartość na true zanim cokolwiek się wczyta
    ...
    ConfigManager.applyData = function(config) {
        ...
        // Jeśli wartość w pliku nie istnieje (undefined), ustawiamy na true
    ...
    Livan_Manager.update = function() {
        ...
        // Sprawdzamy stan z ConfigManager
